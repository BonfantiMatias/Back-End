...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/basicos","/api/skill","/api/educacion", "/api/proyectos","/api/uploads/img/**").permitAll()
		...
		.antMatchers(HttpMethod.GET, "/api/educacion/{id}").hasAnyRole("USER", "ADMIN")
		.antMatchers(HttpMethod.GET, "/api/proyectos/{id}").hasAnyRole("USER", "ADMIN")
		...
		.antMatchers(HttpMethod.POST, "/api/eduacion").hasRole("ADMIN")
		.antMatchers(HttpMethod.POST, "/api/proyectos").hasRole("ADMIN")
		.antMatchers("/api/educacion/**").hasRole("ADMIN")
		.antMatchers("/api/proyectos/**").hasRole("ADMIN")
